...
- Timestamp: `2022-05-13 17:04`
- Build ID: `9445f802-08d9-4a67-ab62-4b4282103e0b`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9445f802-08d9-4a67-ab62-4b4282103e0b.git
$ cd 9445f802-08d9-4a67-ab62-4b4282103e0b
```
